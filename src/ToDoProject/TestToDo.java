...
public class TestToDo {
	...
	public static void kreiranjeRacuna() {
		...
		System.out
				.println("Unesite vas password (mora sadrzavati vise od 7 slova, i 2 broja): ");
		String password = unos.next();

		if (password.length() < 7) {
			System.out
					.println("Password mora sadrzavati vise od 7 slova! Unesite vas password ponovo. ");
			password = unos.next();
		}
	...
	public static void dodavanjeNovogZadatka() {
		System.out.println("Unesite vase ime: ");
		String imeVlasnika = unos.next();
		...
		Date datumKreiranjaZadatka = null;
		String datumKreiranja = noviDateFormat.format(datumKreiranjaZadatka);

		boolean statusZadatka = false;

		Zadatak noviZadatak = new Zadatak(opisZadatka, statusZadatka,
				imeVlasnika, datumKreiranjaZadatka);
